#!/bin/bash
# This script contains common functions used in the Roboshop project
...
print_time(){
    ...
    echo -e "Script executed successfullly, $Y Time taken: $TOTAL_TIME seconds $N" | tee -a $LOG_FILE
}